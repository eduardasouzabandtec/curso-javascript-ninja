...
*/
    ...
    */
    ...
    operador; ok
    - Se o operador não for válido, a função deve retornar "false"; ok
    ...
    */
    ...
    function calculator(operador) {
        ...
        return function (parametro1, parametro2) {
            if (typeof parametro1 !== "number" && typeof parametro2 !== "number") {
                return false;
            }
            return operation[operador](parametro1, parametro2)
        }
    }
    ...
    */
    ...
    function showOperationMessage(operador, numero1, numero2) {
        return `A operaçaõ ${numero1} ${operador} ${numero2} = `
    }
    ...
    */
    ...
    operationSignal = "=";
    var sumError = calculator(operationSignal);
    if (sumError) {
        number1 = 20;
        number2 = 10;
        console.log(showOperationMessage(operationSignal, number1, number2), sumError(number1, number2));
    }
    else {
        console.log(showErrorMessage(operationSignal))
    }
