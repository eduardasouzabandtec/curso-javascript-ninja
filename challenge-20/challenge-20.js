(function () {
    ...
    */
    ...
    function hasMessage(){
        ...
        return isValidEmail($inputEmail.value)
    }
    ...
    */
    ...
    function isValidEmail(email) {
        ...
        var validaRegex = regex.test(email);
        if(validaRegex){
            var confirma = confirm("Tem certeza que deseja enviar o formulário?")
           return confirmaPreenchimento(confirma);
        }
        return console.log("Entre com um e-mail válido!")
    }
    function confirmaPreenchimento(isConfirmado) {
        alert(isConfirmado? "Enviado com sucesso!" : "Não enviado.")
    }
})()
